...
<div id="page-wrapper">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <form role="form" action="{{route('submenu.update',['submenu'=>$submenu, 'menus'=>$menus])}}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('put')
    ...
    @endforeach
                            ...
                            <option value="published" {{$submenu->status==='published'?'selected':''}}>Publish</option>
                                </select>
                            </div>
                            ...
                            <textarea class="form-control" name="description" id="" cols="30" rows="15">{{old('description',$submenu->description)}}</textarea>
                        </div>
