...
@section ('main-container')
        ...
        <div class="all-title-box">
            <div class="container text-center">
                <h1>Academic Details<span class="m_1"><a href="{{url('/')}}">Home</a> / <a href="{{url('/academicdetails')}}">Academic Details</a></span></h1>
            </div>
        </div>
        <!-- Breadcrumb End -->
        <!-- Single News Start-->
                ...
                <div class="row">
                    <div class="col-lg-8">
                        <div class="sn-container">
                            <div class="sn-img">
                                <img src="{{asset('storage/images/academic/'.$academics->academic_img)}}" />
                            </div>
                            <div class="sn-content">
                                <h1 class="sn-title">{{$academics->title}}</h1>
                                <p>
                                    {!!$academics->academic_para!!}
                                </p>
